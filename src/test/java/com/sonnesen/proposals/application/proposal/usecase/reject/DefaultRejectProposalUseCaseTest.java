...
@DisplayName("RejectProposalUseCase Tests")
class DefaultRejectProposalUseCaseTest {

    @InjectMocks
    DefaultRejectProposalUseCase useCase;
    ...
    void shouldThrowExceptionWhenGatewayIsNull() {
        ...
        assertThrows(NullPointerException.class, () -> {
            new DefaultRejectProposalUseCase(null);
        });
    }
}